...
int main(void)
{
	...
	do {
		...
		if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)
		{
			const float turn_coeff_ = 1.0f;
			// move Forward
			Model = glm::translate(dir * 0.01f) * Model;
...
//
//	GLuint vertexbuffer;
//	glGenBuffers(1, &vertexbuffer); //like new
//	glBindBuffer(GL_ARRAY_BUFFER, vertexbuffer);
//	//glBufferData(GL_ARRAY_BUFFER, sizeof(triangle_vertices), triangle_vertices, GL_STATIC_DRAW); // transfer data to gpu from cpu
//	glBufferData(GL_ARRAY_BUFFER, triangle_vertices.size(), &triangle_vertices, GL_STATIC_DRAW); // transfer data to gpu from cpu
//
//	GLuint vertexbuffer2;
//	glGenBuffers(1, &vertexbuffer2);
//	glBindBuffer(GL_ARRAY_BUFFER, vertexbuffer2);
...
//		);
//
//		glm::mat4 Model = glm::mat4(1.0f); //modify for homework...............
//		
//		
//		
//		Model = glm::rotate(Model, glm::radians(30.0f), glm::vec3(0, 1, 0));//vector is for axis
//		
//		
//		
//		glm::mat4 MVP = Projection * View * Model; // responsibb;e fpr ;; the transfomations
//
//
//
//
